...
const files = new Set(["correspondances-morning.json", "correspondances-geography.json", "correspondances-central-cross-morning.json", "correspondances-regional-rer-morning.json", "correspondances-metro-arcs-morning.json"])
for (const manifest of ["correspondances-day-manifest.json", "correspondances-central-cross-day-manifest.json", "correspondances-regional-rer-day-manifest.json", "correspondances-metro-arcs-day-manifest.json"]) {
  files.add(manifest)
