...
import rail from '../../fixtures/idfm/correspondances-regional-rer-morning.json'
import zurich from '../../fixtures/idfm/correspondances-metro-arcs-morning.json'
import geneva from '../../fixtures/idfm/correspondances-tram-marechaux-morning.json'
